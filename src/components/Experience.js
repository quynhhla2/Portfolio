      ...
      <div ref={ref} className="w-[75%] mx-auto relative">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          ...
          <Details
            ...
            company="Microsoft"
            companyLink="wwww.microsoft.com"
            time="Summer 2019"
            address="Redmond, WA."
            ...
            a core system component.orked on a team responsible for developing Amazon's mobile app, including implementing new features such 
            as product recommendations and user reviews, and optimizing the app's performance and reliability."
          />
